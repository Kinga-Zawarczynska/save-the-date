...
export default function Home() {
  ...
  return (
    <WrapperWithBackground imgSrc={bgImg1.src} className="text-white flex flex-col items-start justify-center gap-5 py-30 lg:gap-8 lg:w-100">
      ...
      <p className='text-left'>mają zaszczyt zaprosić Was na uroczystość zawarcia związku małżeńskiego.</p>
      <Details />
